...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "sample_manual_production"
  ...
  config.action_mailer.default_url_options = { protocol: 'https', host:'https://bi-bo-u4dr.onrender.com'}
